...
import com.example.projekwisata.adapter.HotelAdapter;
...
public class HotelActivity extends AppCompatActivity implements HotelAdapter.onSelectData {
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(com.example.projekwisata.activities.HotelActivity.this,
    ...
    private void showHotel() {
        hotelAdapter = new HotelAdapter(com.example.projekwisata.activities.HotelActivity.this, modelHotel, this);
        rvHotel.setAdapter(hotelAdapter);
    }

    @Override
    public void onSelected(ModelHotel modelHotel) {
        Intent intent = new Intent(com.example.projekwisata.activities.HotelActivity.this, DetailHotelActivity.class);
