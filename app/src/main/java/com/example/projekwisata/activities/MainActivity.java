...
import com.example.projekwisata.adapter.MainAdapter;
...
public class MainActivity extends AppCompatActivity implements MainAdapter.onSelectData {
   ...
   public void onSelected(ModelMain mdlMain) {
       switch (mdlMain.getTxtName()) {
            case "Hotel":
               startActivityForResult(new Intent(com.example.projekwisata.activities.MainActivity.this, HotelActivity.class), 1);
               break;
       }
   }
