...
import com.example.projekwisata.adapter.KulinerAdapter;
import com.example.projekwisata.api.Api;
import com.example.projekwisata.decoration.LayoutMarginDecoration;
import com.example.projekwisata.model.ModelKuliner;
import com.example.projekwisata.utils.Tools;
...
public class KulinerActivity extends AppCompatActivity implements KulinerAdapter.onSelectData {
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(com.example.projekwisata.activities.KulinerActivity.this,
    ...
    private void showKuliner() {
        kulinerAdapter = new KulinerAdapter(com.example.projekwisata.activities.KulinerActivity.this, modelKuliner, this);
        rvKuliner.setAdapter(kulinerAdapter);
    }

    @Override
    public void onSelected(ModelKuliner modelKuliner) {
        Intent intent = new Intent(com.example.projekwisata.activities.KulinerActivity.this, DetailKulinerActivity.class);
