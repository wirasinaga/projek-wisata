...
import com.example.projekwisata.adapter.WisataAdapter;
...
public class WisataActivity extends AppCompatActivity implements WisataAdapter.onSelectData {
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(com.example.projekwisata.activities.WisataActivity.this,
    ...
    private void showWisata() {
        kulinerAdapter = new WisataAdapter(com.example.projekwisata.activities.WisataActivity.this, modelKuliner, this);
        rvWisata.setAdapter(kulinerAdapter);
    }

    @Override
    public void onSelected(ModelWisata modelWisata) {
        Intent intent = new Intent(com.example.projekwisata.activities.WisataActivity.this, DetailWisataActivity.class);
