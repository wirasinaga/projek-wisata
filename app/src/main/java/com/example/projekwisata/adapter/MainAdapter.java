...
import com.example.projekwisata.model.ModelMain;

import java.util.List;

public class MainAdapter extends RecyclerView.Adapter<com.example.projekwisata.adapter.MainAdapter.ViewHolder> {

    private List<ModelMain> items;
    private com.example.projekwisata.adapter.MainAdapter.onSelectData onSelectData;

    public interface onSelectData {
        void onSelected(ModelMain mdlMain);
    }

    public MainAdapter(List<ModelMain> items, com.example.projekwisata.adapter.MainAdapter.onSelectData xSelectData) {
        this.items = items;
